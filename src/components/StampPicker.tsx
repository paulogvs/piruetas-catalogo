...
const STAMPS: StampTemplate[] = [
    { label: 'OFERTA 🔥', text: 'OFERTA', fill: '#ffffff', backgroundColor: '#E91E8C', fontFamily: 'Bebas Neue', fontSize: 100 },
    ...
    { label: 'BÁSICO 👕', text: 'BÁSICO', fill: '#ffffff', backgroundColor: '#00BFFF', fontFamily: 'Montserrat', fontSize: 80 },
    ...
    { label: 'MUST HAVE ❤️', text: 'MUST HAVE', fill: '#ffffff', backgroundColor: '#E91E8C', fontFamily: 'Lobster', fontSize: 80 },
];
